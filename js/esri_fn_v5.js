...
require([
    ...
    function roda_Consulta_Nomes(consulta_sql) {
        var params = {
    ...
    var gp_DOM = new Geoprocessor("http://snirh.gov.br/arcgis/rest/services/IG/IG_ConsultaDominio/GPServer/IG_ConsultaDominio");
